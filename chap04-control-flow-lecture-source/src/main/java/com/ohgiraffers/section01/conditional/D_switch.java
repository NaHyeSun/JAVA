    ...
    public void switchVendingMachine(){
        ...
        *     위와 같이 출력되도록 한다. ]*/
        ...
        switch (drink) {
            ...
            default:
                System.out.println("해당 음료는 준비되지 않았습니다. "); return;       //default 일때만 return 값을 주어 아래 문구는 나오지 않으면서 에러도 나지 않게 적용

        }
        System.out.println(drink + "를" + amount +"개 선택하셨습니다." + price + "원 을 투입해주세요. ");
